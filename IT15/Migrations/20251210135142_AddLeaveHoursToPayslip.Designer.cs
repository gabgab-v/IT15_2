...
namespace IT15.Migrations
{
    ...
    [Migration("20251210135142_AddLeaveHoursToPayslip")]
    partial class AddLeaveHoursToPayslip
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IT15.Models.AccountsPayable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("IT15.Models.AccountsReceivable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IT15.Models.CompanyLedger", b =>
                {
                    b.HasOne("IT15.Models.AccountsPayable", "AccountsPayable")
                        .WithMany("LedgerEntries")
                        .HasForeignKey("AccountsPayableId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IT15.Models.AccountsReceivable", "AccountsReceivable")
                        .WithMany("LedgerEntries")
